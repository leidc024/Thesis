...
mlm_boto, mlm_buto = count_word_accuracy(mlm_only_results, "boto", "buto")
...
│ (First Candidate)            │              │            │               │
├──────────────────────────────┼──────────────┼────────────┼───────────────┤
│ ★ Pure MLM-PLL               │   {context_accuracy:6.2f}%    │   {mlm_boto:2d}/50    │    {mlm_buto:2d}/50     │
...
output = {
    ...
    'comparison': {
        ...
        'mlm_pll': {
            'name': 'Pure MLM-PLL (Semantic Only)',
            'strategy': 'MLM pseudo-log-likelihood semantic (100%), no other features',
