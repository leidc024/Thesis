...
cosine_only_polo, cosine_only_pulo = count_word_accuracy(cosine_only_results, "polo", "pulo")
cosine_multi_polo, cosine_multi_pulo = count_word_accuracy(cosine_multi_results, "polo", "pulo")
mlm_polo, mlm_pulo = count_word_accuracy(mlm_results, "polo", "pulo")
...
│ (First Candidate)            │              │            │               │
├──────────────────────────────┼──────────────┼────────────┼───────────────┤
│ Pure Cosine Similarity       │   {cosine_only_accuracy:6.2f}%    │   {cosine_only_polo:2d}/50    │    {cosine_only_pulo:2d}/50     │
│ (Semantic Only)              │ ({cosine_only_imp:+6.2f}%)  │            │               │
├──────────────────────────────┼──────────────┼────────────┼───────────────┤
│ Cosine Sim + Multi-Feature   │   {cosine_multi_accuracy:6.2f}%    │   {cosine_multi_polo:2d}/50    │    {cosine_multi_pulo:2d}/50     │
│ (Old Method)                 │ ({cosine_multi_imp:+6.2f}%)  │            │               │
├──────────────────────────────┼──────────────┼────────────┼───────────────┤
│ ★ MLM PLL + Multi-Feature    │   {context_accuracy:6.2f}%    │   {mlm_polo:2d}/50    │    {mlm_pulo:2d}/50     │
│   (Current Method)           │ ({improvement:+6.2f}%)  │            │               │
└──────────────────────────────┴──────────────┴────────────┴───────────────┘

Note: MaBaybay default always returns first candidate from transliteration.
      For 'ᜉᜓᜎᜓ', candidates are ["polo", "pulo"], so baseline always picks "polo".
""")
...
output = {
    ...
    'comparison': {
        ...
        'cosine_only': {
            ...
            'polo_accuracy': f"{cosine_only_polo}/50",
            'pulo_accuracy': f"{cosine_only_pulo}/50"
        },
        'cosine_multi': {
            ...
            'polo_accuracy': f"{cosine_multi_polo}/50",
            'pulo_accuracy': f"{cosine_multi_pulo}/50"
        },
        'mlm_multi': {
