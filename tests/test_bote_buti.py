...
print(f"Baseline execution time: {baseline_time*1000:.2f}ms ({(baseline_time/100)*1000:.4f}ms per position)")
...
mlm_only_bote, mlm_only_buti = count_word_accuracy(mlm_only_results, "bote", "buti")
...
│ (First Candidate)            │              │            │               │
├──────────────────────────────┼──────────────┼────────────┼───────────────┤
│ ★ Pure MLM-PLL               │   {mlm_only_accuracy:6.2f}%    │   {mlm_only_bote:2d}/50    │    {mlm_only_buti:2d}/50     │
...
output = {
    ...
    'comparison': {
        ...
        'mlm_pll': {
            ...
            'bote_accuracy': f"{mlm_only_bote}/50",
            'buti_accuracy': f"{mlm_only_buti}/50"
        },
