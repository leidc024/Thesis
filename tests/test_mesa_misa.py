...
cosine_only_mesa, cosine_only_misa = count_word_accuracy(cosine_only_results, "mesa", "misa")
cosine_multi_mesa, cosine_multi_misa = count_word_accuracy(cosine_multi_results, "mesa", "misa")
mlm_mesa, mlm_misa = count_word_accuracy(mlm_results, "mesa", "misa")
...
│ (First Candidate)            │              │            │               │
├──────────────────────────────┼──────────────┼────────────┼───────────────┤
│ Pure Cosine Similarity       │   {cosine_only_accuracy:6.2f}%    │   {cosine_only_mesa:2d}/50    │    {cosine_only_misa:2d}/50     │
│ (Semantic Only)              │ ({cosine_only_imp:+6.2f}%)  │            │               │
├──────────────────────────────┼──────────────┼────────────┼───────────────┤
│ Cosine Sim + Multi-Feature   │   {cosine_multi_accuracy:6.2f}%    │   {cosine_multi_mesa:2d}/50    │    {cosine_multi_misa:2d}/50     │
│ (Old Method)                 │ ({cosine_multi_imp:+6.2f}%)  │            │               │
├──────────────────────────────┼──────────────┼────────────┼───────────────┤
│ ★ MLM PLL + Multi-Feature    │   {context_accuracy:6.2f}%    │   {mlm_mesa:2d}/50    │    {mlm_misa:2d}/50     │
│   (Current Method)           │ ({improvement:+6.2f}%)  │            │               │
└──────────────────────────────┴──────────────┴────────────┴───────────────┘

Note: MaBaybay default always returns first candidate from transliteration.
      For 'ᜋᜒᜐ', candidates are ["mesa", "misa"], so baseline always picks "mesa".
""")
...
output = {
    ...
    'comparison': {
        ...
        'cosine_only': {
            ...
            'mesa_accuracy': f"{cosine_only_mesa}/50",
            'misa_accuracy': f"{cosine_only_misa}/50"
        },
        'cosine_multi': {
            ...
            'mesa_accuracy': f"{cosine_multi_mesa}/50",
            'misa_accuracy': f"{cosine_multi_misa}/50"
        },
        'mlm_multi': {
