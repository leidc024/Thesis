...
cosine_only_tela, cosine_only_tila = count_word_accuracy(cosine_only_results, "tela", "tila")
cosine_multi_tela, cosine_multi_tila = count_word_accuracy(cosine_multi_results, "tela", "tila")
mlm_tela, mlm_tila = count_word_accuracy(mlm_results, "tela", "tila")
...
│ (First Candidate)            │              │            │               │
├──────────────────────────────┼──────────────┼────────────┼───────────────┤
│ Pure Cosine Similarity       │   {cosine_only_accuracy:6.2f}%    │   {cosine_only_tela:2d}/50    │    {cosine_only_tila:2d}/50     │
│ (Semantic Only)              │ ({cosine_only_imp:+6.2f}%)  │            │               │
├──────────────────────────────┼──────────────┼────────────┼───────────────┤
│ Cosine Sim + Multi-Feature   │   {cosine_multi_accuracy:6.2f}%    │   {cosine_multi_tela:2d}/50    │    {cosine_multi_tila:2d}/50     │
│ (Old Method)                 │ ({cosine_multi_imp:+6.2f}%)  │            │               │
├──────────────────────────────┼──────────────┼────────────┼───────────────┤
│ ★ MLM PLL + Multi-Feature    │   {context_accuracy:6.2f}%    │   {mlm_tela:2d}/50    │    {mlm_tila:2d}/50     │
│   (Current Method)           │ ({improvement:+6.2f}%)  │            │               │
└──────────────────────────────┴──────────────┴────────────┴───────────────┘

Note: MaBaybay default always returns first candidate from transliteration.
      For 'ᜆᜒᜎ', candidates are ["tela", "tila"], so baseline always picks "tela".
""")
...
output = {
    ...
    'comparison': {
        ...
        'cosine_only': {
            ...
            'tela_accuracy': f"{cosine_only_tela}/50",
            'tila_accuracy': f"{cosine_only_tila}/50"
        },
        'cosine_multi': {
            ...
            'tela_accuracy': f"{cosine_multi_tela}/50",
            'tila_accuracy': f"{cosine_multi_tila}/50"
        },
        'mlm_multi': {
